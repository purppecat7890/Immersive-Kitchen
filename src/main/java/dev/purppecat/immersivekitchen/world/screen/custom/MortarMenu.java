...
public class MortarMenu extends AbstractContainerMenu {
    ...
    public MortarMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ImmersiveKitchenMenuTypes.MORTAR_MENU.get(), pContainerId);
        ...
        this.addSlot(new SlotItemHandler(this.blockEntity.inventory, 0, 56, 34));
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ImmersiveKitchenBlocks.MORTAR.get());
    }
